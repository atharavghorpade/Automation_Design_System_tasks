var metadata = {
    ...
    remediation: "Configure the router to rate limit RSVP messages per interface as shown in the  example.  R2(config)#ip rsvp signaling rate-limit burst 9 maxsize 2100 period 30 limit 50",
    cci: "CCI-001095",
    expectedState: "Configure the router to rate limit RSVP messages per interface as shown in the example.",
...
function check(config) {
    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        if (line.indexOf("interface as".toLowerCase()) !== -1) {
