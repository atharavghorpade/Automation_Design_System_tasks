var metadata = {
    ...
    remediation: "Disable IP directed broadcast on all interfaces as shown in the example below.  R4(config)#int g0/1  R4(config-if)#no ip directed-broadcast",
    cci: "CCI-002385",
    expectedState: "Disable IP directed broadcast on all interfaces as shown in the example below.",
...
function check(config) {
    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        if (line.indexOf("ip directed".toLowerCase()) !== -1) {
